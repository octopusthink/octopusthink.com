...
Technology should be honest, thoughtful, and pleasant to use. More than that, it should improve your life and reduce stress. We think deeply about everything we do in order to build better products that solve real problems in an ethical way. 

</IllustratedPoint>

<IllustratedPoint horizontal label="We listen." illustration={ListenIllustration}>

We love hearing from our users! We fix bugs fast and we plan our roadmap based on user feedback. We also respond personally to every single support request (usually on the same day). We can't always fix everything, but we'll do our best to try.
</IllustratedPoint>

<IllustratedPoint horizontal label="We respect your privacy." illustration={PrivacyIllustration}>

Sorry, but we're just not interested enough to spy on you. We never, ever sell your data or snoop on you. We only collect data to make our product better for you, and we always explain what we're tracking and why—and allow you to opt out. You are not the product.
