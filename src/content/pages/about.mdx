...
<Statistic preUnits="£" number="1185" label="Donated to charity (2020)" />
<Statistic number="1.36" postUnits="k/month" label="Mics muted with Mic Drop" />
<Statistic number="256" postUnits="hours" label="Open-source contributions (2020)" />


<Statistic number="2.4" postUnits="million" label="Monthly localForage downloads" />
<Statistic number="36" postUnits="pots" label="Coffee consumed (day)" />
<Statistic number="1" postUnits="% profits" label="Donation pledge for 2021" />
