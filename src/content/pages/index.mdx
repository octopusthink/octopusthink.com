...
<GridSpanner>
  <ButtonInverse navigation minimal to="/services/">
...
<Panel gridMobile="1fr" gridTablet="1fr 1fr" gridDesktop="1fr 1fr">
  <GridSpanner>
...
<PortfolioCards number={3} />
  ...
  <GridSpanner>
    <Button navigation minimal to="/work/">Peruse our work</Button>
  </GridSpanner>
</Panel>
