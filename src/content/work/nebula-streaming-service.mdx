...
We planned out a flexible and idiomatic React front-end for the site, complete with features like server-side rendering (for OpenGraph tags, SEO, and first-load performance), redux/sagas for predictable data management, SASS for easy CSS management, and 90% test coverage using Jest.
