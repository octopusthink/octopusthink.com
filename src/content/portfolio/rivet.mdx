...
<PortfolioSection
  ...
  Given the complexity of the project, prototyping, in various forms, was critical to its success. We used [Wizard of Oz prototyping](https://en.wikipedia.org/wiki/Wizard_of_Oz_experiment) techniques throughout to continually check if our proposed system was heading in the right direction. We iteratively improved and modified flows and prototypes in response to both customer and technical feedback.
</PortfolioSection>
