...
<PortfolioSummary next="the-challenge">
  ...
  WordPress is still a tool primarily designed to build blogs, and WordPress.com was losing small business customers to competitors. We needed to devise a way
  </div>

  <div>

  ### <Icon name="life-buoy" />Solution
  Sarah designed a tool to help businesses owners build a website in a matter of minutes. By leveraging smart decision making and automation, we were able to simplify the process of designing and building a website.
  </div>
...
<PortfolioSection
  ...
  Rivet was intended to communicate strength, stability, and a DIY approach. We  designed a friendly robot to act as a mascot and guide users. The visual language is based WordPress.com’s visual language at the time, whilst still having its own unique spin.
