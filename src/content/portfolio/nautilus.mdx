...
summary_short: An open-source and inclusive design system and React component library.
...
<ImagePanel dark alt="A mockup showing screenshots of the design system documentation site on a desktop, tablet, and phone." image="/portfolio/nautilus/nautilus-device-mockup-pdf.png" />
