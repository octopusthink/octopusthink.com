...
<div>
  ...
  Nautilus is still very much in progress, but already it's helped us get products and apps up and running much more efficiently than we would have had we needed to work from scratch. Including Nautilus in our projects also means every project benefits from future improvements.
</div>
...
<PortfolioSection
  ...
  It's still early days for Nautilus, but we have a strong vision for the future. Our plans include including React Native functionality, a Sketch or Figma library, brand tokens and themeability, automated theme generation, and an in-browser component playground, in addition to extending and fine-tuning existing rules and components.
