...
<ImagePanel dark alt="A visualisation showing the steps in the user journey, including emotional highlights." image="/portfolio/site-building-study/user-journey-map.png" />

<PortfolioSection
  metadata="Kickoff"
  heading="Stakeholder interviews"
  image="/portfolio/site-building-study/stakeholder-insights.png"
  alt="A board of post-it notes showing insights from stakeholder interviews."
  >

  To kick off the project, I started with a series of stakeholder interviews. I interviewed a variety of people, from project leads to community plugin developers, to inform the scope and goals of the research.
...
<PortfolioSection
  ...
  I gathered requirements and developed an overall project plan. This work was done publicly and [shared with the open-source community](https://make.wordpress.org/design/2018/11/30/exploring-sitebuilding-via-user-research/).
...
<PortfolioSection
  ...
  I facilitated an open session to learn questions that designers and developers working on the project had regarding the site building process. These questions then formed the backbone for the interview script.
...
<PortfolioSection
  ...
  Since our researchers were new to the research process, I created guides for each individual role (moderator, note-taker, and observer) and mentored new researchers in their roles.
...
<PortfolioSection
  ...
  Once we'd finished talking to 17 users, we had a whole lot of data to sift through. I lead the more community researchers in the analysis.
...
<PortfolioSection
  ...
  Next up: we had to turn all that data into usable feedback!
...
<PortfolioSection
  ...
  I led and mentored a team of 25 researchers, many of whom were new to research. In addition to learning a great deal about real users' behaviours and expectations, I generated community interest in participating in and conducting research efforts.
